...
link:https://docs.oracle.com/en/java/docs/books/security/JCA-1.html[Java Cryptography Architecture (JCA)].
It makes common cryptographic operations straightforward without adding any runtime dependencies beyond the JDK.
...
* *Pluggable providers* — works with any JCA provider (e.g., link:https://www.bouncycastle.org/[Bouncy Castle])
...
Check link:https://central.sonatype.com/artifact/com.mirkocaserta.bruce/bruce[Maven Central] for the latest release version.

== Quick Start

All operations are accessed through two static facades.
Add these imports once at the top of your file:
...
Contributions are welcome. See link:CONTRIBUTING.md[CONTRIBUTING.md] for the issue and pull request workflow.

== License

Bruce is released under the link:https://www.apache.org/licenses/LICENSE-2.0[Apache License, Version 2.0].
...
- link:https://github.com/mcaserta/bruce/issues[Issue tracker]
