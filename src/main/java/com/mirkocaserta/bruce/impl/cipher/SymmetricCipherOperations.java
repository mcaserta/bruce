...
public final class SymmetricCipherOperations {
    ...
    public static CipherByKey createCipherByKey(String keyAlgorithm, String cipherAlgorithm, String provider, Mode mode) {
        return createCipherByKey(keyAlgorithm, cipherAlgorithm, Providers.resolve(provider), mode);
    }

    public static CipherByKey createCipherByKey(String keyAlgorithm, String cipherAlgorithm, Provider provider, Mode mode) {
        if (mode == null) {
    ...
    public static com.mirkocaserta.bruce.cipher.symmetric.SymmetricCipher createCipher(byte[] key, String keyAlgorithm, String cipherAlgorithm, String provider, Mode mode) {
        var cipher = createCipherByKey(keyAlgorithm, cipherAlgorithm, Providers.resolve(provider), mode);
    ...
    public static EncodingCipher createEncodingCipher(String key, String keyAlgorithm, String cipherAlgorithm, String provider, Mode mode, Charset charset, Bruce.Encoding encoding) {
        var cipher = createEncodingCipherByKey(keyAlgorithm, cipherAlgorithm, Providers.resolve(provider), mode, charset);
        return (iv, message) -> cipher.encrypt(key, iv, message, encoding);
    }

    private static EncodingCipherByKey createEncodingCipherByKey(String keyAlgorithm, String cipherAlgorithm, Provider provider, Mode mode, Charset charset) {
