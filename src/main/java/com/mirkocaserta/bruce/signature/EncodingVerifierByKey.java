...
/**
 * An interface for verifying the authenticity of messages using encoded digital signatures where
 * the public key is configured in an underlying map using a logical name.
 *
...
public interface EncodingVerifierByKey {
   ...
   *
   * @param publicKeyId the logical name of the public key as configured in the underlying map
