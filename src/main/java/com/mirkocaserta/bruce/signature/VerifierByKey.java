...
/**
 * An interface for verifying the authenticity of messages using digital signatures where the public
 * key is configured in an underlying map using a logical name.
 *
