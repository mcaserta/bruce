...
class EncodingDigesterTest {
  ...
  void sha1Url() {
    final var digester = DigesterImpl.with("SHA1", Encoding.URL);
  ...
  void sha1MIME() {
    final var digester = DigesterImpl.with("SHA1", Encoding.MIME);
    assertEquals("b5ua881ui4pzws3O03/p9ZIm4n0=", digester.apply("message"), "1st sha1");
    assertEquals("2jmj7l5rSw0yVb/vlWAYkK/YBwk=", digester.apply(""), "2nd sha1");
  }
  ...
  void md5Hex() {
    final var digester = DigesterImpl.with("MD5", Encoding.HEX);
  ...
  void md5Base64() {
    final var digester = DigesterImpl.with("MD5", Encoding.BASE64);
  ...
  void md5Url() {
    final var digester = DigesterImpl.with("MD5", Encoding.URL);
    assertEquals("eOcxAn2P1Q7WQjQLfJpjsw==", digester.apply("message"), "1st md5");
    assertEquals("1B2M2Y8AsgTpgAmY7PhCfg==", digester.apply(""), "2nd md5");
  }
  ...
  void md5MIME() {
    final var digester = DigesterImpl.with("MD5", Encoding.MIME);
    assertEquals("eOcxAn2P1Q7WQjQLfJpjsw==", digester.apply("message"), "1st md5");
    assertEquals("1B2M2Y8AsgTpgAmY7PhCfg==", digester.apply(""), "2nd md5");
  }
