...
class EncodingDigesterTest {
    ...
    void sha1Hex() {
        final var digester = digester("SHA1", Bruce.Encoding.HEX);
    ...
    void sha1Base64() {
        final var digester = digester("SHA1", Bruce.Encoding.BASE64);
    ...
    void sha1Url() {
        final var digester = digester("SHA1", Bruce.Encoding.URL);
    ...
    void sha1MIME() {
        final var digester = digester("SHA1", Bruce.Encoding.MIME);
        assertEquals("b5ua881ui4pzws3O03/p9ZIm4n0=", digester.digest("message"), "1st sha1");
        assertEquals("2jmj7l5rSw0yVb/vlWAYkK/YBwk=", digester.digest(""), "2nd sha1");
    }
    ...
    void md5Hex() {
        final var digester = digester("MD5", Bruce.Encoding.HEX);
    ...
    void md5Base64() {
        final var digester = digester("MD5", Bruce.Encoding.BASE64);
    ...
    void md5Url() {
        final var digester = digester("MD5", Bruce.Encoding.URL);
        assertEquals("eOcxAn2P1Q7WQjQLfJpjsw==", digester.digest("message"), "1st md5");
        assertEquals("1B2M2Y8AsgTpgAmY7PhCfg==", digester.digest(""), "2nd md5");
    }
    ...
    void md5MIME() {
        final var digester = digester("MD5", Bruce.Encoding.MIME);
        assertEquals("eOcxAn2P1Q7WQjQLfJpjsw==", digester.digest("message"), "1st md5");
        assertEquals("1B2M2Y8AsgTpgAmY7PhCfg==", digester.digest(""), "2nd md5");
    }
    ...
    void invalidAlgorithm1() {
        Assertions.assertThrows(BruceException.class, () -> digester("foo", Bruce.Encoding.HEX), "No such algorithm: foo");
    }
