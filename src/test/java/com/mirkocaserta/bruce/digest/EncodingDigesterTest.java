...
class EncodingDigesterTest {
    ...
    void sha1Hex() {
        EncodingDigester digester = Crypt.digester("SHA1", Crypt.Encoding.HEX);
    ...
    void sha1Base64() {
        EncodingDigester digester = Crypt.digester("SHA1", Crypt.Encoding.BASE64);
    ...
    void sha1Url() {
        EncodingDigester digester = Crypt.digester("SHA1", Crypt.Encoding.URL);
    ...
    void sha1MIME() {
        EncodingDigester digester = Crypt.digester("SHA1", Crypt.Encoding.MIME);
        assertEquals("b5ua881ui4pzws3O03/p9ZIm4n0=", digester.digest("message"), "1st sha1");
        assertEquals("2jmj7l5rSw0yVb/vlWAYkK/YBwk=", digester.digest(""), "2nd sha1");
    }
    ...
    void md5Hex() {
        EncodingDigester digester = Crypt.digester("MD5", Crypt.Encoding.HEX);
    ...
    void md5Base64() {
        EncodingDigester digester = Crypt.digester("MD5", Crypt.Encoding.BASE64);
    ...
    void md5Url() {
        EncodingDigester digester = Crypt.digester("MD5", Crypt.Encoding.URL);
        assertEquals("eOcxAn2P1Q7WQjQLfJpjsw==", digester.digest("message"), "1st md5");
        assertEquals("1B2M2Y8AsgTpgAmY7PhCfg==", digester.digest(""), "2nd md5");
    }
    ...
    void md5MIME() {
        EncodingDigester digester = Crypt.digester("MD5", Crypt.Encoding.MIME);
        assertEquals("eOcxAn2P1Q7WQjQLfJpjsw==", digester.digest("message"), "1st md5");
        assertEquals("1B2M2Y8AsgTpgAmY7PhCfg==", digester.digest(""), "2nd md5");
    }
    ...
    void invalidAlgorithm1() {
        Assertions.assertThrows(
                ...
                () -> Crypt.digester("foo", Crypt.Encoding.HEX),
