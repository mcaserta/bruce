...
class EncodingDigesterWithCustomProviderTest {
    ...
    void sha1Hex() {
        EncodingDigester digester = digester("SHA1", "BC", Crypt.Encoding.HEX); // use Bouncy Castle provider
    ...
    void sha1Base64() {
        EncodingDigester digester = digester("SHA1", "BC", Crypt.Encoding.BASE64); // use Bouncy Castle provider
    ...
    void sha1Url() {
        EncodingDigester digester = digester("SHA1", "BC", Crypt.Encoding.URL); // use Bouncy Castle provider
    ...
    void sha1MIME() {
        EncodingDigester digester = digester("SHA1", "BC", Crypt.Encoding.MIME); // use Bouncy Castle provider
        assertEquals("b5ua881ui4pzws3O03/p9ZIm4n0=", digester.digest("message"), "1st sha1");
        assertEquals("2jmj7l5rSw0yVb/vlWAYkK/YBwk=", digester.digest(""), "2nd sha1");
    }
    ...
    void md5Hex() {
        EncodingDigester digester = digester("MD5", "BC", Crypt.Encoding.HEX); // use Bouncy Castle provider
    ...
    void md5Base64() {
        EncodingDigester digester = digester("MD5", "BC", Crypt.Encoding.BASE64); // use Bouncy Castle provider
    ...
    void md5Url() {
        EncodingDigester digester = digester("MD5", "BC", Crypt.Encoding.URL); // use Bouncy Castle provider
        assertEquals("eOcxAn2P1Q7WQjQLfJpjsw==", digester.digest("message"), "1st md5");
        assertEquals("1B2M2Y8AsgTpgAmY7PhCfg==", digester.digest(""), "2nd md5");
    }
    ...
    void md5MIME() {
        EncodingDigester digester = digester("MD5", "BC", Crypt.Encoding.MIME); // use Bouncy Castle provider
        assertEquals("eOcxAn2P1Q7WQjQLfJpjsw==", digester.digest("message"), "1st md5");
        assertEquals("1B2M2Y8AsgTpgAmY7PhCfg==", digester.digest(""), "2nd md5");
    }
    ...
    void invalidAlgorithm1() {
        Assertions.assertThrows(
                ...
                () -> digester("foo", "BC", Crypt.Encoding.HEX), // use Bouncy Castle provider
