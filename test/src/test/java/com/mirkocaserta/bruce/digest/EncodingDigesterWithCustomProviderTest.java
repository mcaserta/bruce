...
class EncodingDigesterWithCustomProviderTest {
  ...
  void sha1Hex() {
    final var digester =
        Bruce.digester.with("SHA1", "BC", Encoding.HEX, String.class); // use Bouncy Castle provider
  ...
  void sha1Url() {
    final var digester =
        Bruce.digester.with("SHA1", "BC", Encoding.URL, String.class); // use Bouncy Castle provider
  ...
  void sha1MIME() {
    final var digester =
        Bruce.digester.with(
            "SHA1", "BC", Encoding.MIME, String.class); // use Bouncy Castle provider
    assertEquals("b5ua881ui4pzws3O03/p9ZIm4n0=", digester.apply("message"), "1st sha1");
    assertEquals("2jmj7l5rSw0yVb/vlWAYkK/YBwk=", digester.apply(""), "2nd sha1");
  }
  ...
  void md5Hex() {
    final var digester =
        Bruce.digester.with("MD5", "BC", Encoding.HEX, String.class); // use Bouncy Castle provider
  ...
  void md5Base64() {
    final var digester =
        Bruce.digester.with(
            "MD5", "BC", Encoding.BASE64, String.class); // use Bouncy Castle provider
  ...
  void md5Url() {
    final var digester =
        Bruce.digester.with("MD5", "BC", Encoding.URL, String.class); // use Bouncy Castle provider
    assertEquals("eOcxAn2P1Q7WQjQLfJpjsw==", digester.apply("message"), "1st md5");
    assertEquals("1B2M2Y8AsgTpgAmY7PhCfg==", digester.apply(""), "2nd md5");
  }
  ...
  void md5MIME() {
    final var digester =
        Bruce.digester.with("MD5", "BC", Encoding.MIME, String.class); // use Bouncy Castle provider
    assertEquals("eOcxAn2P1Q7WQjQLfJpjsw==", digester.apply("message"), "1st md5");
    assertEquals("1B2M2Y8AsgTpgAmY7PhCfg==", digester.apply(""), "2nd md5");
  }
